...
import { Globe, Eye, EyeOff, Mail, Lock, User, Phone, MapPin, ArrowRight, CheckCircle } from "lucide-react";
          ...
          <div>
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
              ...
              <div className="space-y-3">
                {["Free forever — no credit card needed", "Plan unlimited trips", "Share with friends & family"].map((f) => (
          ...
          <div className="flex items-center gap-3 mb-8">
            {[1, 2].map((s) => (
              <div key={s} className="flex items-center gap-2">
                ...
                {s < 2 && <div className={`flex-1 h-0.5 w-8 ${step > s ? "bg-orange-500" : "bg-gray-100"}`} />}
              </div>
            ))}
          </div>
